...
@Component({
  selector: 'app-inquiry-fida-legal-person',
  templateUrl: './inquiry-fida-legal-person.component.html',
  styleUrls: ['./inquiry-fida-legal-person.component.css']
})
export class InquiryFidaLegalPersonComponent  implements OnInit,OnDestroy {
  submitted = false;
  ...
  inquiryTaxInfo(): void {
    ...
    console.log(this.fidaoModel.stringFidaId)
    this.servicesSubscriber=  this.service.getFidaLegalPerson(this.fidaoModel.stringFidaId).subscribe(dataResult => {
