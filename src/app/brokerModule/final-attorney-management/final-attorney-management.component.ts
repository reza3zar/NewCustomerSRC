...
ngOnInit() {
  ...
  refreshRequests(){
    ...
    this.brokerRequestsSubscriber = this.attorneyService.getFinalAttorneysOfBrokers().subscribe(result=>
      {
        console.log(result)
...
getSelectedAttorneyRequest(typeOpereation){
  this.getAttorneyRequestByRequestIdSubscriber= this.attorneyService.getAttorneyByIdBrokerSide(this.selectedRequestItemResult.id).subscribe(result=>
    {
...
downloadDocuments(){
  ...
  if(this.selectedRequestItemResult==undefined)
    ...
    this.downloadDocumentsSubscriber= this.documentService.getStatusOfFinalEvidenceBrokerSide(this.selectedRequestItemResult.id,CustomerTypeEnum.UnKnown,DocumentTypeEnum.Attorney).subscribe(result=>{
