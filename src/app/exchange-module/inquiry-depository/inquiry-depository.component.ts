...
@Component({
  selector: 'app-inquiry-depository',
  templateUrl: './inquiry-depository.component.html',
  styleUrls: ['./inquiry-depository.component.css']
})
export class InquiryDepositoryComponent implements OnInit,OnDestroy {
  submitted = false;
  ...
  inquiryTaxInfo(): void {
    ...
    this.servicesSubscriber=  this.service.getDepositoryInfobyPostalCode(this.inquiryTax.postalCode).subscribe(dataResult => {
