...
@Component({
  selector: 'app-inquiry-legal-person',
  templateUrl: './inquiry-legal-person.component.html',
  styleUrls: ['./inquiry-legal-person.component.scss']
})
export class InquiryLegalPersonComponent implements OnInit,OnDestroy {
  submitted = false;
  ...
  inquiryTaxInfo(): void {
    ...
    this._collectionControls=[];
    this.servicesSubscriber=  this.service.getLegalPersonInfobyNationalId(this.inquiryTax.nationalCode).subscribe(dataResult => {
