...
@Component({
  selector: 'ngx-all-customer-management',
  templateUrl: './all-customer-management.component.html',
  styleUrls: ['./all-customer-management.component.scss']
})
export class AllCustomerManagementComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    refreshRequests(){
      ...
      this.totalCount=0;
      this.requestServiceSubscriber = this.brokerRequests.getAllCustomersOfBroker(this.pageSize).subscribe(result=>
        {
          console.log(result)
    ...
    public loadMore(): void {
      ...
      this.loadingGrid = true;
          this.customerSubscriber= this.brokerRequests.getAllCustomersOfBroker(this.pageSize).subscribe(result=>{
